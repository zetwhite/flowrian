...
%token _OPAREN _CPAREN _OCURLY _CCURLY _AT _TOLEFT _TORIGHT
%token _PLUS _MINUS _TIMES _MOD _DIV _GT _LT _GE _LE _EQ _NEQ
%token _INT _FLOAT _STRING _VOID
%token _IF _ELSE _WHILE _START _END
...
%%
Prog   : Stmts       { printf("total program\n"); }
       ; 
...
Stmt   : StDecId _SEMI      { printf("declaration ID\n"); }
       | StDecFunc          { printf("declaration Function\n"); }
...
FuncBody : _OPAREN _START IdList _SEMI Stmts _END Exp _SEMI _CPAREN
